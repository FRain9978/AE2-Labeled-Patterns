...
import org.ae2PatternTagger.items.components.ComponentRegisters;
import org.ae2PatternTagger.menus.InitScreens;
import org.ae2PatternTagger.menus.MenuRegisters;
import org.ae2PatternTagger.network.InitNetwork;
import org.ae2PatternTagger.parts.PartRegisters;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/neoforge.mods.toml file
@Mod(Ae2patterntagger.MODID)
public class Ae2patterntagger {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "ae2patterntagger";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CREATIVE_TAB = CREATIVE_MODE_TABS.register("ae2_pattern_tagger", () ->
            CreativeModeTab.builder()
                    ...
                    .withTabsBefore(AECreativeTabIds.MAIN).icon(() -> ItemRegisters.TAGGER.get().getDefaultInstance())
    ...
    public Ae2patterntagger(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Ae2patterntagger) to respond directly to events.
